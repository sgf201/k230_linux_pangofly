...
read_record_header:
    ...
    if (!renegotiating) {
        if ((ret = mbedtls_ssl_fetch_input(ssl, 5)) != 0) {
            // printf("mmbedtls_ssl_fetch_input1 ret:%d\n",ret);
...
#endif
    {
        ...
        if ((ret = mbedtls_ssl_fetch_input(ssl,
            ...
            MBEDTLS_SSL_DEBUG_RET(1, "mbedtls_ssl_fetch_input", ret);
            // printf("mbedtls_ssl_fetch_input2 ret:%d\n",ret);
            return ret;
        }
...
int mbedtls_ssl_handshake_server_step(mbedtls_ssl_context *ssl)
{
    ...
    switch (ssl->state) {
        ...
        case MBEDTLS_SSL_CLIENT_HELLO:
            ...
            // printf("ssl_parse_client_hello ret:%d\n",ret);
            break;
        ...
        case MBEDTLS_SSL_SERVER_HELLO:
            ...
            // printf("ssl_write_server_hello ret:%d\n",ret);
            break;

        case MBEDTLS_SSL_SERVER_CERTIFICATE:
            ret = mbedtls_ssl_write_certificate(ssl);
            // printf("mbedtls_ssl_write_certificate ret:%d\n",ret);
            break;

        case MBEDTLS_SSL_SERVER_KEY_EXCHANGE:
            ret = ssl_write_server_key_exchange(ssl);
            // printf("ssl_write_server_key_exchange ret:%d\n",ret);
            break;

        case MBEDTLS_SSL_CERTIFICATE_REQUEST:
            ret = ssl_write_certificate_request(ssl);
            // printf("ssl_write_certificate_request ret:%d\n",ret);
            break;

        case MBEDTLS_SSL_SERVER_HELLO_DONE:
            ret = ssl_write_server_hello_done(ssl);
            // printf("ssl_write_server_hello_done ret:%d\n",ret);
            break;
        ...
        case MBEDTLS_SSL_CLIENT_CERTIFICATE:
            ...
            // printf("mbedtls_ssl_parse_certificate ret:%d\n",ret);
            break;

        case MBEDTLS_SSL_CLIENT_KEY_EXCHANGE:
            ret = ssl_parse_client_key_exchange(ssl);
            // printf("ssl_parse_client_key_exchange ret:%d\n",ret);
            break;

        case MBEDTLS_SSL_CERTIFICATE_VERIFY:
            ret = ssl_parse_certificate_verify(ssl);
            // printf("ssl_parse_certificate_verify ret:%d\n",ret);
            break;

        case MBEDTLS_SSL_CLIENT_CHANGE_CIPHER_SPEC:
            ret = mbedtls_ssl_parse_change_cipher_spec(ssl);
            // printf("mbedtls_ssl_parse_change_cipher_spec ret:%d\n",ret);
            break;

        case MBEDTLS_SSL_CLIENT_FINISHED:
            ret = mbedtls_ssl_parse_finished(ssl);
            // printf("mbedtls_ssl_parse_finished ret:%d\n",ret);
            break;
        ...
        case MBEDTLS_SSL_SERVER_CHANGE_CIPHER_SPEC:
            ...
            if (ssl->handshake->new_session_ticket != 0) {
                ...
                // printf("ssl_write_new_session_ticket ret:%d\n",ret);
            } else
#endif
            ret = mbedtls_ssl_write_change_cipher_spec(ssl);
            // printf("mbedtls_ssl_write_change_cipher_spec ret:%d\n",ret);
            break;

        case MBEDTLS_SSL_SERVER_FINISHED:
            ret = mbedtls_ssl_write_finished(ssl);
            // printf("mbedtls_ssl_write_finished ret:%d\n",ret);
            break;
        ...
        case MBEDTLS_SSL_HANDSHAKE_WRAPUP:
            ...
            // printf("mbedtls_ssl_handshake_wrapup ret:%d\n",ret);
            break;
